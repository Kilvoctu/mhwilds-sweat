...
- - Saved Custom Actions `Multiplier` can be set: range 0.00 to 3.00

- The `Multiplier` affects overall sweat accumulation; for example, you can set riding a seikret to 0 to "cool off" and reduce sweat.
